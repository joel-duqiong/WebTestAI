...
**测试目标：** https://www.jd.com/ | **爬取页面：** 20 页 | **测试用例：** 371 个 | **参与 Agent：** 14 个

### 报告特点

- **📊 概览仪表盘**：显示爬取页面数、成功率、测试用例总数、问题数、优先级分布
- **🤖 Agent 角色卡片**：每个 Agent 显示名称、专长、覆盖页数、测试数（如 Sophia-无障碍 覆盖 20 页测试 52 个）
- **📑 页面测试结果表**：每页显示 URL、标题、加载时间、测试通过数、HTTP 状态、展开详情按钮
